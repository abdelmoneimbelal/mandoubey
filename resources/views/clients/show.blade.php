...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">صفحة العميل</h2>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="pl-0">
                        <div class="main-profile-overview">
                            <div class="main-img-user profile-user">
                                <img alt="" src="{{asset($clients->photo)}}">
                            </div>
                            <div class="d-flex justify-content-between mg-b-20">
                                <div>
                                    <h5 class="main-profile-name">{{$clients->name}}</h5>
                                    <p class="main-profile-name-text">{{$clients->email}}</p>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <div>
                                <h6 class="card-title mb-1 text-center">تقييم العميل</h6>
                            </div>
                            <div class="static-rate text-center fs-30">
                                @if($clients->ratings == 1)
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                @elseif($clients->ratings == 2)
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                @elseif($clients->ratings == 3)
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                @elseif($clients->ratings == 4)
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                @elseif($clients->ratings == 5)
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                                    <i class="fa fa-star text-warning" aria-hidden="true"></i>
                ...
                <div class="card-body">
                        ...
                        <ul class="nav nav-tabs profile navtab-custom panel-tabs">
                            ...
                            <li class="active">
                                <a href="#settings" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i
                                                class="las la-cog tx-16 mr-1"></i></span> <span class="hidden-xs">معلومات العميل</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                        ...
                        <div class="tab-pane " id="profile">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="border p-1 card thumb">
                                        <a href="#" class="image-popup" title="Screenshot-2"> <img
                                                    src="{{asset($clients->id_front)}}" class="thumb-img"
                                ...
                                <div class="col-sm-4">
                                    <div class=" border p-1 card thumb">
                                        <a href="#" class="image-popup" title="Screenshot-2"> <img
                                                    src="{{asset($clients->id_back)}}" class="thumb-img"
                                                    alt="work-thumbnail"> </a>
                        ...
                        <div class="tab-pane active" id="settings">
                            ...
                            <form role="form" action="{{ route('status-update', ['id' => $clients->id]) }}"
                                  method="post"
                                  autocomplete="off">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="FullName">الاسم</label>
                                    <input type="text" value="{{$clients->name}}" id="FullName" class="form-control"
                                           readonly>
                                </div>
                                <div class="form-group">
                                    <label for="Email">البريد</label>
                                    <input type="email" value="{{$clients->email}}" id="Email" class="form-control"
                                           readonly>
                                </div>
                                <div class="form-group">
                                    <label for="Username">رقم الهاتف</label>
                                    <input type="text" value="{{$clients->phone}}" id="Username" class="form-control"
                                           readonly>
                                </div>
                                <div class="form-group">
                                    <label for="Username">الجنس</label>
                                    <input type="text" value="@if($clients->type == 'male') ذكر@else انثى@endif"
